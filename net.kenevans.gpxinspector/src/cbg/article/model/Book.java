...
{
    protected static List<Book> newBooks = buildBookList();
    ...
    protected static List<Book> buildBookList() {
        ...
        Book[] books = new Book[] {
            ...
            new Book("The Design Patterns Smalltalk Companion", "Sherman R.",
                "Alpert"), new Book("Design Patterns", "Erich", "Gamma"),
