...
public class ColorThief
{
     ...
     */
    public static int[][] getPalette(BufferedImage sourceImage,
        int colorCount) {
     ...
     */
    private static int[][] getPixelsFast(BufferedImage sourceImage, int quality,
        boolean ignoreWhite) {
     ...
     * @return an array of pixels (each an RGB int array)
     */
    private static int[][] getPixelsSlow(BufferedImage sourceImage, int quality,
        boolean ignoreWhite) {
