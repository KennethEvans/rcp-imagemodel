...
public class MMCQ
{
    ...
    public static class VBox
    {
        ...
        public VBox(int r1, int r2, int g1, int g2, int b1, int b2,
            int[] histo) {
            this.r1 = r1;
            this.r2 = r2;
            this.g1 = g1;
    ...
    private static VBox[] doCut(char color, VBox vbox, int[] partialsum,
     ...
     */
    private static void iter(List<VBox> lh, Comparator<VBox> comparator,
        int target, int[] histo) {
        int ncolors = 1;
        int niters = 0;
        VBox vbox;
